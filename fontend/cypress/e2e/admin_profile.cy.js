  ...
  beforeEach(() => {
    ...
    localStorage.setItem(
      ...
      JSON.stringify({
        id: 1,
        username: 'admin',
        email: 'diamond.hayes@example.com',
        avatar:
          'https://via.placeholder.com/640x480.png/0044ff?text=reiciendis',
        email_verified_at: '2023-11-05T06:25:18.000000Z',
        role: 'admin',
        active: 1,
        activated_at: '+055808-12-08T13:40:00.000000Z',
        active_token: 'cvAZwbm8EsmKTIOOlRh1',
        reset_token: null,
        reset_sent_at: null,
        created_at: '2023-11-05T06:25:18.000000Z',
        updated_at: '2023-11-05T06:25:18.000000Z',
      })
    );
