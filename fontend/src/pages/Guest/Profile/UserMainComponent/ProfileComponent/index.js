        ...
        <Row className='box-content'>
            ...
            <Col span={24} style={{ marginBottom: 16 }}>
                <InputGroupContainer title={'Tên tài khoản:'}>
                    <Input onChange={onChangeUserInfoData} name='username' />
                </InputGroupContainer>
                <InputGroupContainer title={'Họ và tên:'}>
                    <Input onChange={onChangeUserInfoData} name='fullname' />
                </InputGroupContainer>
                <InputGroupContainer title={'Địa chỉ Email:'}>
                    <Input onChange={onChangeUserInfoData} name='email' />
                </InputGroupContainer>
                <InputGroupContainer title={'Giới tính:'}>
                    <Input onChange={onChangeUserInfoData} name='sex' />
                </InputGroupContainer>
                <InputGroupContainer title={'Loại tài khoản:'}>
                    <Input onChange={onChangeUserInfoData} name='accountType' />
                </InputGroupContainer>
                <InputGroupContainer title={'Cấp bậc:'}>
                    <Input onChange={onChangeUserInfoData} name='level' />
                </InputGroupContainer>
            </Col>
