...
const NavigationArea = () => {
  ...
  return (
    <Row className="box-content" style={{ justifyContent: "center", marginRight: 10}} >
      ...
      <NavigationItem startIcon={<ReadOutlined />} content="Truyện đã đăng" action={() => navigate('/profile/posted')} />
      <NavigationItem startIcon={<KeyOutlined />} content="Đổi mật khẩu" action={() => {}} />
      <NavigationItem startIcon={<LogoutOutlined />} content="Đăng xuất" action={() => {}} />
    </Row>
  )
}
