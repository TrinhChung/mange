  ...
  return (
    <Row className="box-content" style={{ justifyContent: "center", marginRight: 10}} >
      <Col>
        ...
        <Row style={{ color: "var(--gray)", justifyContent: "center" }} className='title-children'>
          <Col style={{ fontSize: 16 }} className='color-jade'>ĐỘC GIẢ</Col>
        </Row>
        <Row style={{ color: "var(--gray)", justifyContent: "center" }} className='title-children'>
          <Col style={{ fontSize: 16 }} className='color-main'>VIP 10</Col>
        </Row>
      </Col>
    </Row>
  )
